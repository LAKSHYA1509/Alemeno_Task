...
SECRET_KEY = 'django-insecure-eoi&)(z3jlcdx_@gdat*pv+vo^!f%+$jb76^-e%f6x!f)9tqc#'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DATABASE_NAME', 'alemeno_db'),
        'USER': os.environ.get('DATABASE_USER', 'user'),
        'PASSWORD': os.environ.get('DATABASE_PASSWORD', 'password'),
        'HOST': os.environ.get('DATABASE_HOST', 'db'), # 'db' is the service name in docker-compose
